...
type ClientHandlers = {
  onNewData: (v: {type : string, payload : { member_id : string, room_id : string, data : object}}) => void;
...
const handlers: ClientHandlers = {
  onNewData: (v) => console.log("newData", v.payload.data, v.payload.member_id, v.payload.room_id, v.type),
